...
public class ArticleDetailFragment extends Fragment implements
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        if (getActivity() != null) {
            ...
            Log.d(TAG, "onCreateView: getActivity() returned null");
        }
    ...
    private Date parsePublishedDate() {
        try {
            String date = mCursor.getString(Query.PUBLISHED_DATE);
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            bodyView.setText(Html.fromHtml(mCursor.getString(Query.BODY).replaceAll("(\r\n|\n)", "<br />")));
